    ...
    <el-dialog :title="title" :visible.sync="auditOpen" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="审批意见" prop="auditStatus">
          <el-select v-model="form.auditStatus" placeholder="请选择审批意见">
            <el-option label="审核拒绝" value="1"></el-option>
            <el-option label="审核通过" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="批注信息" prop="info">
          <el-input v-model="form.info" type="textarea" placeholder="请输入批注信息" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
<script>
import { listAudit, getAudit, processCancel, addAudit, updateAudit, getProcessImg, getHistoryTaskList,listTodoTask,audit } from "@/api/business/audit";
